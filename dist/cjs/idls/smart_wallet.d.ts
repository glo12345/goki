export declare type SmartWalletIDL = {
    "version": "0.6.1";
    "name": "smart_wallet";
    "instructions": [
        {
...
export declare const SmartWalletJSON: SmartWalletIDL;
export declare const SmartWalletErrors: import("@saberhq/anchor-contrib").ErrorMap<SmartWalletIDL>;
//# sourceMappingURL=smart_wallet.d.ts.map